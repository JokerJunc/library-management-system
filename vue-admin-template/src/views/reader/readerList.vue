<template>
  <el-main>
    ...
    <el-table :height="tableHeight" :data="tableData" border stripe>
      <el-table-column prop="learnName" label="姓名"></el-table-column>
        ...
        >
          <el-row>
            <el-col :span="12" :offset="0">
              <el-form-item prop="learnName" label="姓名">
                <el-input v-model="addModel.learnName"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12" :offset="0">
...
import { getListApi,addReaderApi,editReaderApi,deleteReaderApi } from "@/api/reader";
export default {
  //注册组件
  components: {
    SysDialog,
  ...
  data() {
    return {
      ...
      rules: {
        learnName: [{ required: true, message: "请填写学号", trigger: "blur" }],
